...
--
-- Dumping data for table `locales_questgiver_greeting`
--

LOCK TABLES `locales_questgiver_greeting` WRITE;
/*!40000 ALTER TABLE `locales_questgiver_greeting` DISABLE KEYS */;
/*!40000 ALTER TABLE `locales_questgiver_greeting` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-10-15  9:43:54

...
--
-- Dumping data for table `locales_trainer_greeting`
--

LOCK TABLES `locales_trainer_greeting` WRITE;
/*!40000 ALTER TABLE `locales_trainer_greeting` DISABLE KEYS */;
/*!40000 ALTER TABLE `locales_trainer_greeting` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-10-15  9:43:57
